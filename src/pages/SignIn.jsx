    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 mx-w-6xl mx-auto">
        <div className="md:w-[60%] lg:w-[45%] mb-12 md:mb-6">
          <img
            src="https://images.unsplash.com/photo-1578699514700-143328993e16?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80"
            alt="s-key"
